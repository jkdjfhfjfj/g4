  ...
  "signals": [
    {
      ...
      "takeProfit": [number] or null (Provide an array containing ONLY the first Take Profit level (TP1). Even if the message lists multiple levels, only include the most conservative or first one.),
    }
  ]
}
